...
async function dashboardPage(req, res) {
	...
	let quizData2 = await studentServices.availableQuiz(studentId);
	let quizData3 = await studentServices.otherQuiz(studentId);

	console.log(quizData);
	res.render("./student/student_dashboard", { errors, upcomingQuiz: quizData.length, otherQuiz: quizData3.length, availableQuiz: quizData2.length });
}
